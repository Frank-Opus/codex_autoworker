...
requires: []
provides:
  - Compatibility matrix established for major Claude-specific behaviors
affects: [phase-02, phase-03, phase-04]
tech-stack:
  added: []
  patterns: [Codex-native migration contract]
key-files:
  created: [docs/migration/codex-compatibility-matrix.md]
  modified: []
key-decisions:
...
**Compatibility matrix captured Claude-specific surfaces and Codex targets**
